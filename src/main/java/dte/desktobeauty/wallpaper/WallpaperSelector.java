...
import dte.desktobeauty.wallpaper.selector.NumericalSelector;
...
public interface WallpaperSelector
{
	...
	{
		return Stream.of(new RandomSelector(), new NumericalSelector(), new RandomOrderSelector(), new GradualRandomSelector())
