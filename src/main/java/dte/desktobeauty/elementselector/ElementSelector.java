...
public interface ElementSelector<T>
{
	...
	/**
	 * Returns an {@code ElementSelector} that corresponds to the provided {@code name}.
	 ...
	 */
	static <T> ElementSelector<T> fromName(String selectorName)
	{
		return Stream.of(new RandomElementSelector<T>(), new RandomOrderSelector<T>())
